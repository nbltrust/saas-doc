...
#### 一、拉取saas最新包(cybex环境)
##### saas后端
- ssh root@121.196.217.176:/home/ops/general/saas/V2.4.2/jadepool-saas-backend-V2.4.2-ubuntu.tar.gz .
##### saas前端
- ssh root@121.196.217.176:/home/ops/general/saas/V2.4.0/jadepool-saas-frontend-V2.4.0-cybex-ubuntu.tar.gz .
##### saas admin
- ssh root@121.196.217.176:/home/ops/general/saas/V2.4.1/jadepool-saas-admin-V2.4.1-ubuntu.tar.gz .
...
##### saas admin
- ssh root@121.196.217.176:/home/ops/general/saas/V2.4.1/jadepool-saas-admin-V2.4.1-prefix-ubuntu.tar.gz .
#### 二、停用saas服务
#### 三、替换后端包
#### 四、替换前端包
#### 五、替换admin包
