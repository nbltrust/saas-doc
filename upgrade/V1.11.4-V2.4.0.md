...
#### 七、数据库更新
1. INSERT INTO hub_wallets (created_at, updated_at, hub_wallet_id) VALUES ('2020-04-14 09:56:28.136873+00', '2020-04-14 09:56:28.136873+00', 'default')
2. 设置刚才添加的hub_wallet的wallet_blockchain_list为这热主钱包所有链的id数组， wallet_asset_list为所有币的name列表
3. 修改companies列表里hub_wallet_id为空的改为default
